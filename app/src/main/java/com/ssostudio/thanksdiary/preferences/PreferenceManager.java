package com.ssostudio.thanksdiary.preferences;
...
public class PreferenceManager {
     ...
     *
     */
    private static String isPremiumKey = "isPremium";
    private static String freeDateKey = "freeDate";

    public static void setIsPremium(Context context, boolean isPremium) {
        setBoolean(context, isPremiumKey, isPremium);
    }

    public static boolean getIsPremium(Context context) {
        return getBoolean(context, isPremiumKey);
    }

    public static void setFreeDate(Context context, long date) {
        setLong(context, freeDateKey, date);
    }

    public static long getFreeDate(Context context) {
        return getLong(context, freeDateKey);
    }
